...
def cast_ray(tilemap: TileMap, caster: Caster) -> list[(int, int, float, pg.Vector2, False)]:
    "Cast a ray and return a list of results. A result is a tuple of: `(ray_ind, data (ID of the tile), distance, ray_hit_pos, is_y_side)`"

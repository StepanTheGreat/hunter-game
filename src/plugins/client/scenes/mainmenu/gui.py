...
class MainMenuGUI:
    ...
    def enter_mainmenu_subscene(self):
        ...
        play_btn = (TextButton(font, "Create Game", (0.5, 0.5), MainMenuGUI.BUTTON_SIZE, text_scale=0.5)
    ...
    def enter_settings_subscene(self):
        ...
        background = ColorRect((100, 0, 100))
        ...
        vsync_label = Label(font, "Vsync: ", (0, 1), text_scale=0.5).attached_to(keys_label)
